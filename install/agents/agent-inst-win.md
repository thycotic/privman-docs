...
* __Core Thycotic Agent__
  ```
  msiexec.exe /i "ThycoticAgent_x64_10_8_1101.msi" /norestart AMSURL=https://SERVERNAME/TMS/ INSTALLCODE=XXXX1234ABCD REBOOT=ReallySuppress /qn
  ```
...
* __Local Security Agent__
  ```
  msiexec.exe /i "Thycotic_LocalSecurityAgent_x64_10_8_1090.msi" /norestart REBOOT=ReallySuppress /qn
  ```
...
* Core Thycotic Agent
  ```
  msiexec.exe /i "ThycoticAgent_x86_10_8_1101.msi" /norestart AMSURL=https://SERVERNAME/TMS/ INSTALLCODE=XXXX1234ABCD REBOOT=ReallySuppress /qn
  ```
...
* Local Security Agent
  ```
  msiexec.exe /i "Thycotic_LocalSecurityAgent_x86_10_8_1090.msi" /norestart REBOOT=ReallySuppress /qn
  ```
