...
* Added API Client User logout option via delete method to [API Authentication](https://docs.thycotic.com/privman-api/10.8.0/authentication#delete) endpoint.
...
* X-Powered-By information returned in 301 and 400 http reponses.
