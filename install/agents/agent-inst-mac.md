...
1. Go to [Agent Downloads](https://tmsnuget.thycotic.com/software/Agents/ThycoticManagementAgent-10.7.29.dmg) and download the Privilege Manager Mac Agent.
...
sudo installer -pkg ThycoticManagementAgent-10.7.29.pkg -target /
```
...
```shell
sudo /Volumes/ThycoticManagementAgent-10.7.29/Uninstall.sh
```
