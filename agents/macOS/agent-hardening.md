...
* /Applications/Privilege Manager.app
  ...
  This application bundle contains the Privilege Manager launch agent, the com.thycotic.acsd launch daemon, and the com.thycotic.acsd.systemextension system extension, which together implement the main functionality of the PM agent.
