...
* When installing Privilege Manager on a Windows Server 2012 pointed to a DB that is running on SQL Server 2017 or above will need to leverage the SSDT binaries only available in .NET 4.6 or above. Server 2012 only has .NET 4.5.1.
