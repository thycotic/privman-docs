...
* Modified [policy with Allow Package Installation action workflow](../computer-groups/macOS/examples/index.md#sysex_based_agent_behavior_with_actions) behavior for .pkg installs with SYSEX based agents.
