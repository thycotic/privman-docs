[title]: # (Upgrading from Arellia Management Server 8.2 to Privilege Manager 10.4 and up)
[tags]: # (new version)
[priority]: # (2)
# Upgrading from Arellia Management Server 8.2 to Privilege Manager 10.4 and up

Upgrading from our 8.2 version to our latest 10.4 version and up can’t be done from `https://servername/Ams/Setup/`. To upgrade, we recommend using the same database and removing the old application before installing the new version. This can be done automatically or manually.
...
1. The agents on the endpoints should then be upgraded to the latest version available at `https://thycotic.force.com/support/s/article/Software-Download`
...
1. Download and deploy the latest agents https://thycotic.force.com/support/s/article/Software-Download.
